import type { ExerciseEntry, MuscleStatus } from './workoutStorage';
 ...
 */
function exerciseHitsMuscle(exercise: ExerciseEntry): boolean {
  return (exercise.score ?? 0) > 50 && exercise.sets >= 2 && exercise.reps >= 5;
}
 ...
 */
export function calculateWorkoutScore(exercises: ExerciseEntry[], muscleStatus: MuscleStatus[]) {
 ...
 */
function getHitMuscles(exercises: ExerciseEntry[], muscleStatus: MuscleStatus[]): Set<string> {
