  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="px-6 pt-6 pb-4">
        <div className="inline-flex items-center gap-2 px-3 py-2 bg-green-600/20 border border-green-500/40 rounded-full">
          <CameraIcon className="w-4 h-4 text-green-400" />
          <span className="text-sm font-bold text-green-300 uppercase tracking-wide">Photo Mode</span>
        </div>
      </div>

      {/* Instructions Card */}
      <div className="px-6 mb-6">
        <Card className="p-5 bg-gradient-to-br from-blue-600/20 to-purple-600/15 border-blue-500/40 shadow-xl">
          <h3 className="font-bold text-white mb-2 drop-shadow-[0_0_8px_rgba(255,255,255,0.4)]">
            Ready to record?
          </h3>
      ...
      <div className="flex-1 flex items-center justify-center relative px-6">
        <div className="w-full aspect-[3/4] max-h-[500px] bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-3xl border-2 border-gray-700/50 flex items-center justify-center relative overflow-hidden shadow-2xl">
          {/* Camera Icon Placeholder */}
          <div className="absolute inset-0 flex items-center justify-center">
            <CameraIcon className="w-32 h-32 text-gray-600/30" />
          </div>
      ...
      <div className="px-6 py-8">
        <div className="flex items-center justify-center gap-8 mb-8">
          {/* Upload Button */}
          <button className="w-14 h-14 rounded-full bg-gray-800 border-2 border-gray-700 flex items-center justify-center hover:bg-gray-700 transition-colors active:scale-95">
            <Upload className="w-6 h-6 text-gray-300" />
          </button>

          {/* Capture Button */}
          <button className="w-20 h-20 rounded-full bg-white shadow-[0_0_40px_rgba(255,255,255,0.6)] flex items-center justify-center hover:scale-105 transition-transform active:scale-95 relative">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 shadow-inner" />
          </button>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-300/80 font-medium">
                  Record your sets for AI scoring
                </p>
              </div>
            </div>
          </Card>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-green-300/80 font-medium">
                  Snap a photo for nutrition analysis
                </p>
              </div>
            </div>
          </Card>
