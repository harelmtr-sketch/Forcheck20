...
export function LoginSwoosh({ onComplete }: LoginSwooshProps) {
  ...
  return (
    <div
      className={`fixed inset-0 bg-gradient-to-br from-[#1a1d23]/95 via-[#1d2128]/95 to-[#1a1d23]/95 backdrop-blur-sm z-50 flex items-center justify-center transition-all duration-300 ${
        phase === 'entering' 
          ? 'opacity-100' 
          : 'opacity-0'
      }`}
